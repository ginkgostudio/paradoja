<?php function thb_image( $atts, $content = null ) {
  ...
  $out = !empty($link_to) ? '<a '.$c_lightbox.' href="'.$link_to.'" target="'.esc_attr( $a_target ).'>" title="'.esc_attr( $a_title ).'"><div class="simple-overlay"></div>'.$img['thumbnail'].'</a>' : $img['thumbnail'];
