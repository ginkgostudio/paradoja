		...
		<div class="menu-container custom_scroll">
			...
			<div class="menu-holder">
				<?php if ($page_menu) { ?>
                    ...
                    <?php wp_nav_menu( array( 'theme_location' => 'new-menu', 'container' => false, 'menu_class' => 'mobile-menu sf-menu', 'walker' => new thb_mobileDropdown) ); ?>
		...
		<header class="header row no-padding <?php echo $header_style; ?>" data-equal=">.columns" role="banner">
			...
			<div class="small-5 <?php if ($header_style == 'style2') { echo 'medium-8'; } else { echo 'medium-4';} ?> columns menu-holder">
				...
				<?php if ($full_menu_true) { ?>
                    ...
                    <nav id="full-menu2" role="navigation">
						<?php if ($page_menu) { ?>
                            <?php wp_nav_menu( array( 'theme_location' => 'new-menu', 'container' => false, 'menu_class' => 'full-menu', 'walker' => new thb_mobileDropdown) ); ?>                       
						<?php } else  if(has_nav_menu('nav-menu')) { ?>
                          <?php wp_nav_menu( array( 'theme_location' => 'new-menu', 'container' => false, 'menu_class' => 'full-menu', 'walker' => new thb_mobileDropdown ) ); ?> 
						<?php } else { ?>
							<ul class="full-menu">
